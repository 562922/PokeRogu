...
const modifierPool: ModifierPool = {
  ...
  [ModifierTier.GREAT]: [
    ...
    new WeightedModifierType(modifierTypes.VOUCHER, (party: Pokemon[], rerollCount: number) => !party[0].scene.gameMode.isDaily ? Math.max(1 - rerollCount, 0) : 0, 1),
  ].map(m => {
  ...
  [ModifierTier.ROGUE]: [
    ...
    new WeightedModifierType(modifierTypes.VOUCHER_PLUS, (party: Pokemon[], rerollCount: number) => !party[0].scene.gameMode.isDaily ? Math.max(3 - rerollCount * 1, 0) : 0, 3),
  ].map(m => {
  ...
  [ModifierTier.MASTER]: [
    ...
    new WeightedModifierType(modifierTypes.VOUCHER_PREMIUM, (party: Pokemon[], rerollCount: number) =>
